...
// >g++ -g mainWindow.cpp -o mainWindow.exe

#define _WIN32_WINNT 0x0500 // Es necesaria esta definicion para esconder ventana de consola. Indica plataformas de destino.
